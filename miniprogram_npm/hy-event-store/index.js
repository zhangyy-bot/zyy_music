...
__DEFINE__(1647950965246, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1647950965247,"./event-store":1647950965248}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647950965247, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1647950965248, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1647950965247,"./utils":1647950965249}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647950965249, function(require, module, exports) {
...
return __REQUIRE__(1647950965246);
})()
